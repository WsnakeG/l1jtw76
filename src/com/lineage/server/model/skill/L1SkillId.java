...
public class L1SkillId {
	 ...
	 * 舞躍之火155
	 */
	public static final int DANCING_BLAZE = 155; // E: BLESS_OF_FIRE
	 ...
	 * 拘束移動
	 */
	public static final int POWERGRIP = 228;
	 ...
	 * 粉碎
	 */
	public static final int PASSIVE_CRASH = 233;

	/**
	 * 狂暴
	 */
	public static final int PASSIVE_FURY = 234;

	/**
	 * 迅猛雙斧
	 */
	public static final int PASSIVE_SLAYER = 235;

	/**
	 * 護甲身軀
	 */
	public static final int PASSIVE_ARMORGARDE = 236;

	/**
	 * 泰坦：岩石
	 */
	public static final int PASSIVE_TITANROCK = 237;

	/**
	 * 泰坦：子彈
	 */
	public static final int PASSIVE_TITANBULLET = 238;

	/**
	 * 泰坦：魔法
	 */
	public static final int PASSIVE_TITANMAGIC = 239;
	...
	// 附魔石
	/** 附魔石(近戰) */
	// public static final int BS_GX00 = 0000;
	...
	/** 附魔石(近戰) 體力上限+50、體力恢復量+1 */
	public static final int BS_GX05 = 4405;

	/** 附魔石(近戰) 體力上限+60、體力恢復量+2 */
	public static final int BS_GX06 = 4406;

	/** 附魔石(近戰) 體力上限+70、體力恢復量+3 */
	public static final int BS_GX07 = 4407;

	/** 附魔石(近戰) 體力上限+80、體力恢復量+4、近距離命中率+1 */
	public static final int BS_GX08 = 4408;

	/** 附魔石(近戰) 體力上限+120、體力恢復量+5、近距離命中率+2、近距離攻擊力+2、力量+1 */
	public static final int BS_GX09 = 4409;

	/** 附魔石(遠攻) */
	// public static final int BS_AX00 = 0000;

	/** 附魔石(遠攻) 體力上限+5、魔力上限+3 */
	public static final int BS_AX01 = 4411;

	/** 附魔石(遠攻) 體力上限+10、魔力上限+6 */
	public static final int BS_AX02 = 4412;

	/** 附魔石(遠攻) 體力上限+15、魔力上限+10 */
	public static final int BS_AX03 = 4413;

	/** 附魔石(遠攻) 體力上限+20、魔力上限+15 */
	public static final int BS_AX04 = 4414;

	/** 附魔石(遠攻) 體力上限+25、魔力上限+20 */
	public static final int BS_AX05 = 4415;

	/** 附魔石(遠攻) 體力上限+30、魔力上限+20、體力恢復量+1 */
	public static final int BS_AX06 = 4416;

	/** 附魔石(遠攻) 體力上限+35、魔力上限+20、體力恢復量+1、魔力恢復量+1 */
	public static final int BS_AX07 = 4417;

	/** 附魔石(遠攻) 體力上限+40、魔力上限+25、體力恢復量+2、魔力恢復量+1 */
	public static final int BS_AX08 = 4418;

	/** 附魔石(遠攻) 體力上限+50、魔力上限+30、體力恢復量+2、魔力恢復量+2、遠距離命中率+2、遠距離攻擊力+2、敏捷+1 */
	public static final int BS_AX09 = 4419;

	/** 附魔石(恢復) */
	// public static final int BS_WX00 = 0000;
	...
	/** 附魔石(恢復) 魔力上限+25、魔力恢復量+1 */
	public static final int BS_WX05 = 4425;

	/** 附魔石(恢復) 魔力上限+30、魔力恢復量+2 */
	public static final int BS_WX06 = 4426;

	/** 附魔石(恢復) 魔力上限+35、魔力恢復量+3 */
	public static final int BS_WX07 = 4427;

	/** 附魔石(恢復) 魔力上限+40、魔力恢復量+4 */
	public static final int BS_WX08 = 4428;

	/** 附魔石(恢復) 魔力上限+50、魔力恢復量+5、魔法攻擊+3、智力+1 */
	public static final int BS_WX09 = 4429;

	/** 附魔石(防禦) */
	// public static final int BS_ASX00 = 0000;
	...
	/** 附魔石(防禦) 防禦-15、魔法防禦+15、額外傷害減免+1 */
	public static final int BS_ASX08 = 4438;

	/** 附魔石(防禦) 防禦-20、魔法防禦+20、額外傷害減免+3、體質+1 */
	public static final int BS_ASX09 = 4439;
	...
	public static final int DS_GX09 = 4509;
	...
	public static final int DS_AX09 = 4519;
	...
	public static final int DS_WX09 = 4529;
	...
	public static final int DS_ASX09 = 4539;

	// 1段經驗加倍

	/** 130%倍經驗加倍 */
	public static final int EXP13 = 6668;
	...
	/** 安塔瑞斯的血痕 - 防禦力-2, 攻擊水龍傷害x1.5, 水屬性魔防+50 */
	public static final int DRAGON_BLOOD_1 = 6797;

	/** 法利昂的血痕 - 體力恢復量+3, 魔力恢復量+1, 攻擊風龍傷害x1.5, 風屬性魔防+50 */
	public static final int DRAGON_BLOOD_2 = 6798;

	/** 林德拜爾的血痕 - ???, 攻擊火龍傷害x1.5, 火屬性魔防+50 */
	...
	// 積分加倍
	public static final int SCORE04 = 7001;
	...
	/** 霸王色霸氣 by terry0412 */
	public static final int DOMINATE_POWER_A = 5006;

	/** 聞見色霸氣 by terry0412 */
	public static final int DOMINATE_POWER_B = 5007;

	/** 武裝色霸氣 by terry0412 */
	public static final int DOMINATE_POWER_C = 5008;

	/** 魔化色霸氣 by terry0412 */
	public static final int DOMINATE_POWER_D = 5009;

	/** 廣播卡判斷時間 by terry0412 */
	public static final int BROADCAST_CARD = 5010;

	/** 元寶偵測紀錄 (每XX秒判斷一次) by terry0412 */
	public static final int ADENA_CHECK_TIMER = 5011;

	/** 轉生技能道具A by terry0412 */
	public static final int MAGIC_ITEM_POWER_A = 5012;

	/** 轉生技能道具B by terry0412 */
	public static final int MAGIC_ITEM_POWER_B = 5013;

	/** 轉生技能道具C by terry0412 */
	public static final int MAGIC_ITEM_POWER_C = 5014;

	/** 轉生技能道具C by terry0412 */
	public static final int MAGIC_ITEM_POWER_D = 5015;

	/** 淨化藥水 by terry0412 */
	public static final int POTION_OF_PURIFICATION = 5016;

	public static final int AICHECK = 20006;

	public static final int AICHECK_PN = 20007;

	/** 快樂時光(gm指令) **/
	public static final int HAPPY_TIME = 20008;

	public static final int VIP = 2008;

	public static final int ONLINE_GIFT = 2009;

	public static final int MAZU_STATUS = 2010;

	public static final int ARMOR_SETS_GFX = 2011;

	public static final int WEAPON_SETS_GFX = 2012;
	 ...
	 * 釣魚
	 */
	public static final int FISHING = 3524;

	/** AI驗證用 */
	public static final int AIFORSTART = 7020;
	public static final int AIFOREND = 7021;
	
	/** 攻擊賦予狀態 判斷用 by hpc20207 */
	public static final int ATTACK_PVP = 23456;
