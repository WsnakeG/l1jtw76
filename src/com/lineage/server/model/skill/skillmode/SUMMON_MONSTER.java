...
public class SUMMON_MONSTER extends SkillMode {
	...
	public void start(final L1PcInstance srcpc, final Object obj) throws Exception {
		...
		// 傳回質
		summonstr_list = new String[] { "7", "263", "519", "8", "264", "520", "9", "265", "521", "10", "266",
				"522", "11", "267", "523", "12", "268", "524", "13", "269", "525", "14", "270", "526", "15",
				"271", "527", "16", "17", "18", "274" };

		// NPCID
		summonid_list = new int[] { 81210, 81211, 81212, 81213, 81214, 81215, 81216, 81217, 81218, 81219,
				81220, 81221, 81222, 81223, 81224, 81225, 81226, 81227, 81228, 81229, 81230, 81231, 81232,
				81233, 81234, 81235, 81236, 81237, 81238, 81239, 81240 };

		// 等級
		summonlvl_list = new int[] { 28, 28, 28, 32, 32, 32, 36, 36, 36, 40, 40, 40, 44, 44, 44, 48, 48, 48,
				52, 52, 52, 56, 56, 56, 60, 60, 60, 64, 68, 72, 72 };

		// 魅力
		summoncha_list = new int[] { 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 10, 10,
				10, 12, 12, 12, 20, 42, 42, 44 };
