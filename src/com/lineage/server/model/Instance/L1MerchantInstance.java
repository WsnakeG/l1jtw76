	...
	public void onTalkAction(final L1PcInstance player) {
		...
		if (talking != null) {
			if (npcid == 70841) { // ルーディエル
				 ...
				 * { // ヘイト終了済み htmlid = "heit5"; } else if (lv45_step >= 3) {
				 * // フルート交換済み htmlid = "heit3"; } else if (lv45_step >= 2) { //
				 * ヘイト同意済み htmlid = "heit2"; } else if (lv45_step >= 1) { //
				 * マシャー同意済み htmlid = "heit1"; } }
				 */

				/*
				 * } else if (npcid == 70904) { // クプ if (player.isDarkelf()) {
				 * if (quest.get_step(L1PcQuest.QUEST_LEVEL45) == 1) { //
				 * ブルディカ同意済み htmlid = "koup12"; } }
				 */
				...
				/*
				 * } else if (npcid == 80094) { // 祭壇 if
				 * (player.isIllusionist()) { htmlid = "altar1"; } else if
				 * (!player.isIllusionist()) { htmlid = "altar2"; }
				 */
			} else if (npcid == 80099) { // 治安団長ラルソン
				if (player.getQuest().get_step(L1PcQuest.QUEST_GENERALHAMELOFRESENTMENT) == 1) {
					if (player.getInventory().checkItem(41325, 1)) {
						htmlid = "rarson8";
					} else {
						htmlid = "rarson10";
					}
				} else if (player.getQuest().get_step(L1PcQuest.QUEST_GENERALHAMELOFRESENTMENT) == 2) {
				...
				} else if (player.getQuest().get_step(L1PcQuest.QUEST_GENERALHAMELOFRESENTMENT) == 3) {
					htmlid = "rarson14";
				} else if (player.getQuest().get_step(L1PcQuest.QUEST_GENERALHAMELOFRESENTMENT) == 4) {
				...
				} else if (player.getQuest().get_step(L1PcQuest.QUEST_GENERALHAMELOFRESENTMENT) >= 5) {
					htmlid = "rarson1";
				}
			} else if (npcid == 80101) { // クエン
				if (player.getQuest().get_step(L1PcQuest.QUEST_GENERALHAMELOFRESENTMENT) == 4) {
					if ((player.getInventory().checkItem(41315, 1))
						...
						player.getQuest().set_step(L1PcQuest.QUEST_GENERALHAMELOFRESENTMENT, 1);
					}
				} else if ((player.getQuest().get_step(L1PcQuest.QUEST_GENERALHAMELOFRESENTMENT) == 2)
						&& (player.getInventory().checkItem(41317, 1))) {
					htmlid = "kuen3";
