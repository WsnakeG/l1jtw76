...
public class L1CastleLocation {
	...
	// →↑がX軸、→↓がY軸
	// TODO 肯特城
	private static final int KENT_TOWER_X = 33168; //33139

	private static final int KENT_TOWER_Y = 32779; //32768
	...
	public static int[] getGetBackLoc(final int castle_id) {
		...
		case DIAD_CASTLE_ID: // 狄亞得要塞
			...
			final int[][] loctmp = new int[][] { new int[] { 32792, 32807, 310 },
					new int[] { 32816, 32820, 310 }, new int[] { 32823, 32797, 310 }, };
			loc = loctmp[rnd];
			/*
			 * loc = new int[3]; if (rnd == 0) { loc[0] = 32792; loc[1] = 32807;
			 * loc[2] = 310; } else if (rnd == 1) { loc[0] = 32816; loc[1] =
			 * 32820; loc[2] = 310; } else if (rnd == 2) { loc[0] = 32823;
			 * loc[1] = 32797; loc[2] = 310; }
			 */
			break;
