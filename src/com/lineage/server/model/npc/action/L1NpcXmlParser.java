...
public class L1NpcXmlParser {
	...
	public static ArrayList<Integer> jdMethod_do(final String ints) {
		final StringTokenizer tok = new StringTokenizer(ints.replace(" ", ""), ",");
	...
	public static int[] jdMethod_for(final String npcIds) {
