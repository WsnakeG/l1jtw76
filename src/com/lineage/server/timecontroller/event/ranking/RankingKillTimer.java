...
public class RankingKillTimer extends TimerTask {
	...
	private static void load() {
		try {
			 ...
			 * continue; } if (tgpc.getOnlineStatus() == 0) { continue; } if
			 * (tgpc.getNetConnection() == null) { continue; } // 殺手排行榜 final
			 * int killCount = tgpc.get_other().get_killCount(); if (killCount >
			 * 0) { _killName = intTree(killCount, tgpc.getName(), _killName); }
