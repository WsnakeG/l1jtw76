...
public class OutErrorMsg {
	...
	public static void put(final String className, final String string, final Throwable t) {
		_log.error(string);
		final StringBuilder putInfo = new StringBuilder();
		putInfo.append(string + "###");
		final StackTraceElement locations[] = t.getStackTrace();

		for (final StackTraceElement stackTraceElement : locations) {
			/*
	...
	public static void put(final int oid, final String string) {
		_log.error(string);
		final StringBuilder putInfo = new StringBuilder();
	...
	private static void overOut(final String name, final StringBuilder string) {
		try {
			...
			for (final String txt : clientStrAry) {
