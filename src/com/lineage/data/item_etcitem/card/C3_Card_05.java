 ...
 * @author dexc
 */
public class C3_Card_05 extends ItemExecutor {

	private static final Log _log = LogFactory.getLog(C3_Card_05.class);

	private static final int _key = 5;
