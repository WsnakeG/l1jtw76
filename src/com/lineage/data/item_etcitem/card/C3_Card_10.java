 ...
 * @author dexc
 */
public class C3_Card_10 extends ItemExecutor {

	private static final Log _log = LogFactory.getLog(C3_Card_10.class);

	private static final int _key = 10;
