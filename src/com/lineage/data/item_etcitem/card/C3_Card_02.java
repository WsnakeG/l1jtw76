 ...
 * @author dexc
 */
public class C3_Card_02 extends ItemExecutor {

	private static final Log _log = LogFactory.getLog(C3_Card_02.class);

	private static final int _key = 2;
