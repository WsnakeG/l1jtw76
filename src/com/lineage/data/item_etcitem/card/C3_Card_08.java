 ...
 * @author dexc
 */
public class C3_Card_08 extends ItemExecutor {

	private static final Log _log = LogFactory.getLog(C3_Card_08.class);

	private static final int _key = 8;
