...
/**
 * C3_WATER [水攻術] 每次使用60秒 只對玩家有效 使用水攻之後，角色身上的物理攻擊降為0 取代為水系傷害，隨著等級的提升傷害更大
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		try {
			...
			if (pc.hasSkillEffect(L1SkillId.C3_WATER)) {// 水攻術
				pc.sendPackets(
						new S_ServerMessage("\\fV[水攻術]效果尚存:" + pc.getSkillEffectTimeSec(L1SkillId.C3_WATER)));
				return;
			}
			...
			pc.setSkillEffect(L1SkillId.C3_WATER, _time * 1000);
