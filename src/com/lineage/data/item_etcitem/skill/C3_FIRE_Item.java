...
/**
 * C3_FIRE [火轉術] 每次使用60秒 只對玩家有效 使用火轉術之後，角色身上的物理攻擊降為0 取代為火焰傷害，隨著等級的提升傷害更大
 * 但敵方抗性越高受到的傷害越小 等級50-70 消耗三國貨幣X1 30-100傷害 等級70-90 消耗三國貨幣X1 40-110傷害 等級90-110
 * 消耗三國貨幣X1 50-120傷害 等級110-130 消耗三國貨幣X1 60-130傷害 等級130-150 消耗三國貨幣X1 80-140傷害
 * 
 * @author dexc
 */
public class C3_FIRE_Item extends ItemExecutor {

	private static final Log _log = LogFactory.getLog(C3_FIRE_Item.class);

	/**
	 *
	 */
	private C3_FIRE_Item() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new C3_FIRE_Item();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		try {
			...
			if (pc.hasSkillEffect(L1SkillId.C3_FIRE)) {// 火轉術
				pc.sendPackets(
						new S_ServerMessage("\\fV[火轉術]效果尚存:" + pc.getSkillEffectTimeSec(L1SkillId.C3_FIRE)));
				return;
			}
			...
			pc.setSkillEffect(L1SkillId.C3_FIRE, _time * 1000);
			pc.sendPacketsX8(new S_SkillSound(pc.getId(), 214));
