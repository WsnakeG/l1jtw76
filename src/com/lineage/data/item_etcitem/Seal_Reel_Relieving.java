...
public class Seal_Reel_Relieving extends ItemExecutor {
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		if (((item1 != null) && (item1.getItem().getType2() == 1)) || (item1.getItem().getType2() == 2)
				|| ((item1.getItem().getType2() == 0) && ((lockItemId == 40314) || (lockItemId == 40316)
						|| (lockItemId == 41248) || (lockItemId == 41249) || (lockItemId == 41250)
						|| (lockItemId == 49037) || (lockItemId == 49038) || (lockItemId == 49039)))) {
			if ((item1.getBless() == 128) || (item1.getBless() == 129) || (item1.getBless() == 130)
					|| (item1.getBless() == 131)) {
				int bless = 1;
