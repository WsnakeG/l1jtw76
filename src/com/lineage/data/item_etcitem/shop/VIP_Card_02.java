 ...
 * 44130 三國[金卡]
 */
public class VIP_Card_02 extends ItemExecutor {

	private static final Log _log = LogFactory.getLog(VIP_Card_02.class);
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		try {
			...
			// 44130 三國[金卡]
			// 44189 三國日卡[金]
			final int[] itemids = new int[] { 44130, 44189 };
