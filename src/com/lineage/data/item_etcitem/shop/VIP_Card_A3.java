...
public class VIP_Card_A3 extends ItemExecutor {
	...
	private static final Log _log = LogFactory.getLog(VIP_Card_A3.class);
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		try {
			...
			// 44131 三國[白金卡]
			// 44190 三國日卡[白金]
			final int[] itemids = new int[] { 44131, 44190 };
