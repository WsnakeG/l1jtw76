 ...
 * WHERE `item_id`='44135';
 */
public class Up_Score_04 extends ItemExecutor {

	private static final Log _log = LogFactory.getLog(Up_Score_04.class);
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		try {
			...
			pc.setSkillEffect(SCORE04, 20 * 60 * 1000);
