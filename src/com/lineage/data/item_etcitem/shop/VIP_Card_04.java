 ...
 * 44132 三國[白金限量卡]
 */
public class VIP_Card_04 extends ItemExecutor {

	private static final Log _log = LogFactory.getLog(VIP_Card_04.class);
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		try {
			...
			// 44132 三國[白金限量卡]
			// 44191 三國日卡[白金限量]
			final int[] itemids = new int[] { 44132, 44191 };
