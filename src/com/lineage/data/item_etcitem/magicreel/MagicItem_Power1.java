...
/**
 * [特殊技能道具] 施放後xx秒內受到物理與魔法傷害無效化、 扣除道具、數量、特效編號、 使用道具不會消失開關
 * 
 * @author terry0412
 */
public class MagicItem_Power1 extends ItemExecutor {

	/**
	 *
	 */
	private MagicItem_Power1() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new MagicItem_Power1();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		pc.setSkillEffect(MAGIC_ITEM_POWER_A, _timeSecs * 1000);

		pc.sendPackets(new S_SystemMessage(_timeSecs + " 秒內 物理與魔法傷害無效化"));
	}

	private static int _timeSecs;

	private static int _consumeItemId;
	private static int _consumeItemCount;
