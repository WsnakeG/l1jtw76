...
import static com.lineage.server.model.skill.L1SkillId.MAGIC_ITEM_POWER_B;
...
/**
 * [特殊技能道具] 施放後xx秒內使用魔法治癒術或生命的祝福(補血量X2倍)、 扣除道具、數量、特效編號、 使用道具不會消失開關
 * 
 * @author terry0412
 */
public class MagicItem_Power2 extends ItemExecutor {

	/**
	 *
	 */
	private MagicItem_Power2() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new MagicItem_Power2();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		pc.setSkillEffect(MAGIC_ITEM_POWER_B, _timeSecs * 1000);

		pc.sendPackets(new S_SystemMessage(_timeSecs + "秒內使用魔法治癒術或生命的祝福(補血量X2倍)"));
	}
