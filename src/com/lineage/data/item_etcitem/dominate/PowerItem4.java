...
/**
 * 魔化色霸氣 (參數:[機率使用魔法攻擊傷害X2倍] [效果持續多少秒] [特效編號 (每3秒1次)])
 * 
 * @author terry0412
 */
public class PowerItem4 extends ItemExecutor {
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		if (_value2 > 0) {
			pc.setSkillEffect(DOMINATE_POWER_D, _value2 * 1000);
