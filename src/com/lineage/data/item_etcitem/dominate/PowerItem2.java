...
/**
 * 聞見色霸氣 (參數:[機率受到負面魔法無效化] [效果持續多少秒] [特效編號 (每3秒1次)])
 * 
 * @author terry0412
 */
public class PowerItem2 extends ItemExecutor {
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		if (_value2 > 0) {
			pc.setSkillEffect(DOMINATE_POWER_B, _value2 * 1000);
