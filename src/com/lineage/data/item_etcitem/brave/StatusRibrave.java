...
/**
 * 生命之樹果實類型<br>
 * classname: StatusRibrave<br>
 * <br>
 * 設置對象:道具(etcitem)<br>
 * <br>
 * 設置範例:brave.StatusRibrave 480 7110 96<br>
 * 生命之樹果實技能效果時間480秒 動畫7110 龍騎士/幻術師可用<br>
 * <br>
 * 職業分類<br>
 * 王族可執行:1<br>
 * 騎士可執行:2<br>
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		if (L1BuffUtil.stopPotion(pc)) {
			if (check(pc)) {
				...
				pc.setSkillEffect(L1SkillId.STATUS_RIBRAVE, _time * 1000);
