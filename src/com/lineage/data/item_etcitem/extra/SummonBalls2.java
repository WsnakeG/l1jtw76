...
/**
 * 怪物召喚球 (參數:召喚怪物ID, 召喚數量, 持續召喚時間, 召喚單隻所需魅力, 使用後是否刪除, 召喚所需道具, 召喚所需數量)
 * 
 * @author terry0412
 */
public class SummonBalls2 extends ItemExecutor {

	/**
	 *
	 */
	private SummonBalls2() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new SummonBalls2();
	}
	...
	private static int _consumeItemId; // 召喚所需道具
	
	private static int _consumeItemCount; // 召喚所需道具數量
	...
	public void set_set(final String[] set) {
		try {
			...
			_consumeItemId = Integer.parseInt(set[6]);
			_consumeItemCount = Integer.parseInt(set[7]);
