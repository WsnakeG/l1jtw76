...
public class Poly_Magic_Wand extends ItemExecutor {
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		if ((pc.getMapId() == 63) || (pc.getMapId() == 552) || (pc.getMapId() == 555)
				|| (pc.getMapId() == 557) || (pc.getMapId() == 558) || (pc.getMapId() == 779)) { // 水中不可使用
	...
	private void polyAction(final L1PcInstance attacker, final L1Character cha) {
		...
		final int[] polyArray = { 29, 945, 947, 979, 1037, 1039, 3860, 3861, 3862, 3863, 3864, 3865, 3904,
				3906, 95, 146, 2374, 2376, 2377, 2378, 3866, 3867, 3868, 3869, 3870, 3871, 3872, 3873, 3874,
				3875, 3876 };
		...
		if (cha instanceof L1PcInstance) {
			...
			if (mob.getLevel() < 50) {
				...
				if ((npcId != 45338) && (npcId != 45370) && (npcId != 45456) && (npcId != 45464)
						&& (npcId != 45473) && (npcId != 45488) && (npcId != 45497) && (npcId != 45516)
						&& (npcId != 45529) && (npcId != 45458)) {
					final L1Skills skillTemp = SkillsTable.get().getTemplate(SHAPE_CHANGE);
