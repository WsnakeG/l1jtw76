...
public class Npc_DragonA2 extends NpcExecutor {
	...
	private final L1QuestUser set_init(final int showId) {
		try {
			...
			// 召喚門
			L1SpawnUtil.spawnDoor(quest, 10008, 7858, 32741, 32712, (short) mapid, 0); // A
																						// 32739
																						// 32712
																						// 1011
																						// A
																						// /
			L1SpawnUtil.spawnDoor(quest, 10009, 7859, 32779, 32681, (short) mapid, 1); // B
																						// 32779
																						// 32681
																						// 1011
																						// B
																						// \
			L1SpawnUtil.spawnDoor(quest, 10010, 7858, 32861, 32709, (short) mapid, 0); // C
																						// 32861
																						// 32709
																						// 1011
																						// C
