...
public class Npc_NewUser extends NpcExecutor {
	...
	public void talk(final L1PcInstance pc, final L1NpcInstance npc) {
		...
		final int[] allBuffSkill = new int[] { ADVANCE_SPIRIT, BLESS_WEAPON, PHYSICAL_ENCHANT_STR,
	...
	private void startSkill(final L1PcInstance pc, final L1NpcInstance npc, final int skillid) {
		...
		skillUse.handleCommands(pc, skillid, objid, x, y, 0, L1SkillUse.TYPE_NPCBUFF, npc);
	}
}
