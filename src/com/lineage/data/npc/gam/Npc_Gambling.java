...
public class Npc_Gambling extends NpcExecutor {
	...
	public void talk(final L1PcInstance pc, final L1NpcInstance npc) {
		...
		if (gambling == null) {
			...
			for (final Integer key : GamblingTime.get_gambling().get_allNpc().keySet()) {
				final GamblingNpc o = GamblingTime.get_gambling().get_allNpc().get(key);
				final String name = o.get_npc().getNameId();
				final long adena = o.get_adena();
