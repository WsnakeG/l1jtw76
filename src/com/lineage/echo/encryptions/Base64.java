...
public class Base64 {
	...
	private static byte[] encode3to4(final byte[] threeBytes) {
	...
	private static byte[] encode3to4(final byte[] threeBytes, final int numSigBytes) {
	 ...
	 * @since 1.3
	 */
	private static byte[] decode4to3(final byte[] fourBytes) {
		final byte[] outBuff1 = new byte[3];
		final int count = decode4to3(fourBytes, 0, outBuff1, 0);
